				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="/">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="/faculty">Faculty</a></p>
						</div>
					</div>
				</div>
			</section>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 info-area-right">
							<h1>What do we think of you?</h1>
							<p>For teachers like us, there is nothing more fun than going to class every day to impart our understanding to the future generations of the country, we always cherish and cherish each student. whatever the external circumstances.</p>
							<br>
							<p>
								We always put your thoughts and requirements, especially the students,
								on the top because our mission is to give the highest priority to the needs or to constantly think about students, we are always ready to serve you,
								 service for your participation when entering the university gate of 5SUPERHERO.
							</p>
						</div>
					</div>
				</div>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Goals to be achieved in the upcoming school year</h1>
								<p>We always focus on meticulousness and progress.</p>
							</div>
						</div>
					</div>
                    <div class="row">
                        <div class="col-md-6 accordion-left">
                            ...
                            <dl class="accordion">
                                ...
                                <dd>
									The mission of 5SUPERHERO University is to train high-quality human resources in the integration period,
									provide global competitiveness for learners, and contribute to the expansion of the country's intellectual frontiers.
                                </dd>
                                <dt>
                                    <a href="">Quality</a>
                                </dt>
                                <dd>
									Raise the quality of all training programs to a high level according to regional
									or international accreditation standards; put the University in the top group in the region according to the employability ranking of graduates.
                                </dd>
                                <dt>
                                    <a href="">Success</a>
                                </dt>
                                <dd>
                                    Building a model of success and sustainable development of a fully autonomous university with
									an advanced governance model, a strong financial system, campus infrastructure and modern facilities on par with the region.
                                </dd>
                                <dt>
                                    <a href="">Creation</a>
                                </dt>
                                <dd>
                                    Building an innovative, open and international academic environment;
									attracting excellent students, excellent scholars nationally and internationally to study, research and work.
                                </dd>
                            </dl>
                            <!-- accordion 2 end-->
                        </div>
