...
<body>
				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="/">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="/admissions"> Admissions</a></p>
						</div>
					</div>
				</div>
			</section>
    ...
    <!-- Start admissions information -->
    <div class="whole-wrap">
        <div class="container">
            <div class="section-top-border">
                <h3 class="mb-30 text-center view-more">Admissions Information</h3>
                <br>
                <br>
                <div class="row">
                    <div class="col-md-4">
                        <div class="single-defination">
                            <h4 class="mb-20 view-more">Registration procedure</h4>
                            <p>APPLICATION PROCEDURES Eligible candidates for admission to 5SUPERHERO University can apply...</p>
                        </div>
                        <a href="#" class="details-admission"><span
                            class="details">Details </span><span class="lnr lnr-arrow-right"></span></a>
                    </div>
                    <div class="col-md-4">
                        <div class="single-defination">
                            <h4 class="mb-20 view-more">Scholarship – credit</h4>
                            <p>SCHOLARSHIP RULES - CREDIT IN 2022 CHOOSE REGULAR UNIVERSITY STUDENTS AT…</p>
                        </div>
                        <a href="#" class="details-admission"><span
                            class="details">Details </span><span class="lnr lnr-arrow-right"></span></a>
                    </div>
                    <div class="col-md-4">
                        <div class="single-defination">
                            <h4 class="mb-20 view-more">Frequently asked questions</h4>
                            <p>PART 1: ENROLLMENT CONDITIONS 1. I have a desire to attend 5SUPERHERO University. Can you tell…</p>
                ...
                <br>
                <br>
                <div class="text-center view-comments">View all</div>
            </div>
        </div>
    </div>
    <!-- End admissions information -->
    ...
    <div class="whole-wrap">
        <div class="container">
            <div class="section-top-border">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <h3 class="mb-20 text-center">REGISTER</h3>
                        <form action="#">
							<div class="row">
								<div class="col-6">
									<h5  class="primary-text title-text">Full Name</h5>
									<div class="mt-10">
										<input type="text" name="full_name" placeholder="Full Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Full Name'" required class="single-input single-input-full">
									</div>
								</div>
								<div class="col-6">
									<h5  class="primary-text title-text">Gender</h5>
									<div class="mt-10">
										<input type="text" name="gender" placeholder="Gender" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Gender'" required class="single-input single-input-full">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-6">
									<h5 class="primary-text title-text">Birthday</h5>
									<div class="mt-10">
										<input type="date" name="birthday" placeholder="Birthday" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Birthday'" required class="single-input single-input-full">
									</div>
								</div>
								<div class="col-6">
									<h5 class="primary-text title-text">Phone Number</h5>
									<div class="mt-10">
										<input type="tel" name="phone" placeholder="Phone Number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone Number'" required class="single-input single-input-full">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-6">
									<h5 class="primary-text title-text">Email</h5>
									<div class="mt-10">
										<input type="email" name="EMAIL" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'" required class="single-input single-input-full">
									</div>
								</div>
								<div class="col-6">
									<h5 class="primary-text title-text">Address</h5>
									<div class="input-group-icon mt-10">
                                		<div class="icon"><i class="fa fa-thumb-tack" aria-hidden="true"></i></div>
                                		<input type="text" name="address" placeholder="Address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Address'" required class="single-input single-input-full">
                            		</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-6">
									<h5 class="primary-text title-text">City</h5>
									<div class="input-group-icon mt-10  single-input-full">
										...
										<div class="form-select" id="default-select">
											<select>
												...
												<option value="1">Orther</option>
											</select>
										</div>
									</div>
								</div>
								<div class="col-6">
									<h5 class="primary-text title-text">Country</h5>
									<div class="input-group-icon mt-10  single-input-full">
							...
							<h5 class="primary-text title-text">Link Facebook</h5>
                            <div class="mt-10">
                                <input type="text" name="facebook" placeholder="Link Facebook" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Link Facebook'" required class="single-input-primary">
                            </div>
							<h5 class="primary-text title-text">Message</h5>
                            <div class="mt-10">
                                <textarea class="single-textarea" placeholder="Message" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Message'" required></textarea>
                            </div>
							<a href="" class="primary-btn text-uppercase mx-auto btn-register">Register</a>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="section-top-border">
                <h3 class="mb-30">Our Rating</h3>
                <div class="progress-table-wrap">
                    <div class="progress-table">
                        <div class="table-head">
                            <div class="serial">#</div>
                            <div class="country">University</div>
                            <div class="visit">Identifiers</div>
                            <div class="percentage">Percentages</div>
                        </div>
                        <div class="table-row">
                            <div class="serial">01</div>
                            <div class="country"> <img src="img/elements/f1.jpg" alt="flag">Stanford </div>
                        ...
                        <div class="table-row">
                            ...
                            <div class="country"> <img src="img/elements/f2.jpg" alt="flag">5SUPERHERO</div>
                            <div class="visit">638989</div>
                            <div class="percentage">
                                <div class="progress">
                        ...
                        <div class="table-row">
                            ...
                            <div class="country"> <img src="img/elements/f3.jpg" alt="flag">Oxford </div>
                            <div class="visit">625192</div>
                            <div class="percentage">
                                <div class="progress">
                                    <div class="progress-bar color-3" role="progressbar" style="width: 75%" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                        <div class="table-row">
                            <div class="serial">04</div>
                            <div class="country"> <img src="img/elements/f4.jpg" alt="flag">Harvard </div>
                            <div class="visit">599099</div>
                            <div class="percentage">
                                <div class="progress">
                                    <div class="progress-bar color-4" role="progressbar" style="width: 70%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                        <div class="table-row">
                            <div class="serial">05</div>
                            <div class="country"> <img src="img/elements/f5.jpg" alt="flag">London </div>
                            <div class="visit">588903</div>
                            <div class="percentage">
                                <div class="progress">
                        ...
                        <div class="table-row">
                            ...
                            <div class="country"> <img src="img/elements/f6.jpg" alt="flag">Zurich </div>
                            <div class="visit">572168</div>
                            <div class="percentage">
                                <div class="progress">
                        ...
                        <div class="table-row">
                            ...
                            <div class="country"> <img src="img/elements/f7.jpg" alt="flag">Chicago </div>
                            <div class="visit">566868</div>
                            <div class="percentage">
                                <div class="progress">
                                    <div class="progress-bar color-7" role="progressbar" style="width: 60%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                        <div class="table-row">
                            <div class="serial">08</div>
                            <div class="country"> <img src="img/elements/f8.jpg" alt="flag">RMIT</div>
                            <div class="visit">556738</div>
                            <div class="percentage">
                                <div class="progress">
                                    <div class="progress-bar color-8" role="progressbar" style="width: 55%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div class="row">
				<div class="active-popular-carusel">
					...
					<div class="single-popular-carusel">
						...
						<div class="details">
							<a href="/course-details-photography">
								<h4>
									Learn Photography
								</h4>
							</a>
